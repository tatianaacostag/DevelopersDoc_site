---
title: "Consultas API"
linkTitle: "Consultas API"
date: 2021-04-30T08:51:22-05:00
description: >
  Consultas API lets you check the status of the placed orders along with their transactions.
weight: 30
tags: ["subtopic"]
---
To integrate with Consultas API, target your request to the following URLs according to your environment.
...
## Available methods
Consultas API includes the following methods:

* [Query by Order Id]({{< ref "#query-by-order-id" >}})
* [Query by Transaction Id]({{< ref "#query-by-transaction-id" >}})
* [Query by Reference Id]({{< ref "#query-by-reference-id" >}})
* [Ping]({{< ref "#ping" >}})
