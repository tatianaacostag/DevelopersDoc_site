...
| transactionResponse > additionalInfo > rejectionType | Alfanumérico | Máx: 4 | Indica la categoría del rechazo. Valores posibles: `SOFT` o `HARD`. Para más información, consulta [Consideraciones]({{< ref "Payments-API-Panama.md#considerations" >}}). |
