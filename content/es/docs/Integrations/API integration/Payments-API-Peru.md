...
* Puedes realizar capturas parciales sobre un monto autorizado. Para esto, necesitas enviar en la petición el parámetro `transaction.additionalValues.TX_VALUE` con su valor (Como se envió durante la Autorización).
