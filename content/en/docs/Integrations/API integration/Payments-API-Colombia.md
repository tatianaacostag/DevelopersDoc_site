...
* [Submit Transactions Using Nequi]({{< ref "Payments-API-Colombia.md#submit-transactions-using-nequi" >}})<!-- * [Submit Transactions Using Bancolombia Button]({{< ref "#submit-transactions-using-bancolombia-button" >}}) -->
