...
| transactionResponse > additionalInfo > rejectionType | Alphanumeric | Max: 4 | Indicates the category of the decline. Possible values: `SOFT` or `HARD`. For more information, refer to [Considerations]({{< ref "Payments-API-Peru.md#considerations" >}}). |
...
* The minimum value to capture can be 10% lower than the amount authorized.
* The payment networks release the no captured value at 2-10 days for local cards and 28 days for foreign cards.
