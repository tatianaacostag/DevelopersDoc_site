...
| transaction > paymentMethod | Alphanumeric | 32 | Select a valid Credit or Debit card Payment Method. [See the available Payment Methods for Argentina]({{< ref "select-your-payment-method.html#img-srcassetsperupng-width25px-peru" >}}). |
...
| transaction > paymentMethod | Alphanumeric | 32 | Select a valid Payment Method in cash. [See the available Payment Methods for Argentina]({{< ref "select-your-payment-method.html#img-srcassetsperupng-width25px-peru" >}}). |
| transaction > paymentCountry | Alphanumeric | 2 | Set `PE` for Peru. |
