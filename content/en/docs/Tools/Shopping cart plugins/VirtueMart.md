...
* For VirtueMart version 3.0.6:
  * Having the PayU's VirtueMart plugin downloaded and stored in an accessible location. Click [here](/assets/plugins/plugin-joomla-virtuemart3.0.6.zip) to download it. 
