...
This feature has been deprecated and it is not offered for new commerces.

**Related topics**
* [Tokenization SDK]({{< ref "TokenizationSDK.md" >}})
* [Payments]({{< ref "Payments.md" >}})
{{% /alert %}}

## How does it work? 
![Concepts](http://developers.payulatam.com/images/pagos-recurrentes1-en.jpg)
